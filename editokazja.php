...
<form method="POST" action="okazjaview.php" style="width: 100%;">
    ...
    <div class="adminbox-1" style="background-color: unset;">
            <a class="btn btn-secondary" href="usunokazje.php?id_okazja=<?=$o['id_okazja']?>">Usuń okazje</a>
            <a class="btn btn-secondary" href="edytuj.php?id_okazja=<?=$o['id_okazja']?>">Edytuj okazje</a>
    </div>
    </form>
</div>
<?php
