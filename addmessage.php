...
<body>
    <?php
        ...
        $sql = 'INSERT INTO okazja (id_uzytkownik, id_image, cena_okazja, tytul_okazja, opis_okazja, link_okazja, data_dodania) 
        VALUES (1, :image_okazja, :cena_okazja, :tytul_okazja, :opis_okazja, :link_okazja, CURRENT_TIMESTAMP)';
        $sth = $dBase->prepare($sql);
