    ...
    <div class="container-fluid">
        <header class="bg-dark">
            <nav class="row navbar navbar-dark bg-dark d-flex flex-nowrap">
                ...
                <div class="col-10 ml-auto mr-auto d-md-flex justify-content-end" id="one2">
                    <form class="d-none d-lg-block form-inline my-2 my-lg-0 justify-content-end flex-nowrap" method="GET" action="szukajuser.php">
        ...
        <footer class="page-footer font-small mdb-color lighten-3 pt-4">
            ...
            <div class="footer-copyright text-center py-3">© 2020 Copyright:
                <a href="indexuser.php"> Chilli.pl</a>
            </div>
        </footer>
