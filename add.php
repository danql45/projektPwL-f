                ...
                <div class="col" id="addokazja1">
                    ...
                    <form action="addmessage.php" method="GET">
                        ...
                        <div id="tekstinputadd">
                            <div>
                                <h3>LINK</h3>
                                <input type="text" placeholder="http://www.example.com/deal..." name="link_okazja"><br>
                                <input type="text" placeholder="link do zdjęcia produktu(opcjonalnie)" name="image_okazja">
                            </div><br>
                            ...
                            <div>
                                ...
                                <div class="d-flex" style="margin-bottom: 10px;">
                                    <input style="margin-right: 10px;" placeholder="0,00" type="decimal" name="cena_okazja">
                                </div>
                                <h6>TYTUŁ OFERTY</h6>
                                <div class="d-flex">
                                    <input style="margin-right: 10px;" type="text" placeholder="Krótki tytuł opisujący znalezioną okazję" name="tytul_okazja">
                                </div>
                            </div><br>
                            <div>
                                <h6>Opis</h6>
                                <input style="height: 200px;" type="text" placeholder="Opisz znalezioną okazje własnymi słowami." name="opis_okazja">
                            </div><br>
                        </div>
